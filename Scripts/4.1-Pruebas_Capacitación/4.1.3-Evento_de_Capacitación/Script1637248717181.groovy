...
if (WebUI.waitForElementClickable(findTestObject('Modulo Pruebas Capacitación/Evento_de_Capacitacion/td_prueba'), 1)) {
    ...
    WebUI.click(findTestObject('Modulo Pruebas Capacitación/Evento_de_Capacitacion/a_Regresar'))
}

if (WebUI.waitForElementPresent(findTestObject('Modulo Pruebas Capacitación/Evento_de_Capacitacion/a_Nuevo'), 1)) {
    ...
    if (WebUI.waitForElementClickable(findTestObject('Modulo Pruebas Capacitación/Evento_de_Capacitacion/td_prueba'), 1)) {
        ...
        if (WebUI.waitForElementVisible(findTestObject('Modulo Pruebas Capacitación/Evento_de_Capacitacion/td_24122021'), 
            1)) {
            WebUI.click(findTestObject('Modulo Pruebas Capacitación/Evento_de_Capacitacion/div_Ubicacin_ui-chkbox-box ui-widget ui-corner-all ui-state-default ui-state-hover'))
