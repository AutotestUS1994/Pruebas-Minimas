...
WebUI.comment('Solo funciona con firefox por que formulario no sale completo formulario individual')

WebUI.comment('si se elimina un colaborador no se actualizan los cupos del evento')
