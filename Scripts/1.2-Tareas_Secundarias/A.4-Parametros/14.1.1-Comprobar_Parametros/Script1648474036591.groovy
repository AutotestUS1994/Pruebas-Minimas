...
def parEntidadInstructor() {
    WebUI.click(findTestObject('Modulo Parametros/Comprobar Parametros/a_Entidad'))

    WebUI.waitForElementVisible(findTestObject('Modulo Parametros/Comprobar Parametros/a_Nuevo'), 0)

    WebUI.click(findTestObject('Modulo Parametros/Comprobar Parametros/a_Instructor'))
...
def parCosteo() {
    ...
    WebUI.click(findTestObject('Modulo Parametros/Comprobar Parametros/a_Lnea  Costo'))

    WebUI.waitForElementVisible(findTestObject('Modulo Parametros/Comprobar Parametros/a_Nuevo'), 0)

    WebUI.click(findTestObject('Modulo Parametros/Comprobar Parametros/a_Zona Econmica'))

    WebUI.waitForElementVisible(findTestObject('Modulo Parametros/Comprobar Parametros/a_Nuevo'), 0)

    WebUI.click(findTestObject('Modulo Parametros/Comprobar Parametros/a_Centro Costo'))

    WebUI.waitForElementVisible(findTestObject('Modulo Parametros/Comprobar Parametros/a_Nuevo'), 0)

    WebUI.click(findTestObject('Modulo Parametros/Comprobar Parametros/a_Proyecto'))

    WebUI.waitForElementVisible(findTestObject('Modulo Parametros/Comprobar Parametros/a_Nuevo'), 0)

    WebUI.click(findTestObject('Modulo Parametros/Comprobar Parametros/a_Actividades'))

    WebUI.waitForElementVisible(findTestObject('Modulo Parametros/Comprobar Parametros/a_Nuevo'), 0)
}

def parValor() {
    WebUI.click(findTestObject('Modulo Parametros/Comprobar Parametros/a_Variable Cargo'))

    WebUI.waitForElementVisible(findTestObject('Modulo Parametros/Comprobar Parametros/a_Nuevo'), 0)

    WebUI.click(findTestObject('Modulo Parametros/Comprobar Parametros/a_Variable Cargo Por Zona'))

    WebUI.waitForElementVisible(findTestObject('Modulo Parametros/Comprobar Parametros/a_Nuevo'), 0)

    WebUI.click(findTestObject('Modulo Parametros/Comprobar Parametros/a_Variable Por Rol'))

    WebUI.waitForElementVisible(findTestObject('Modulo Parametros/Comprobar Parametros/a_Nuevo'), 0)

    WebUI.click(findTestObject('Modulo Parametros/Comprobar Parametros/a_Variable Empresa'))

    WebUI.waitForElementVisible(findTestObject('Modulo Parametros/Comprobar Parametros/a_Nuevo'), 0)

    WebUI.click(findTestObject('Modulo Parametros/Comprobar Parametros/a_Variable Grupo'))

    WebUI.waitForElementVisible(findTestObject('Modulo Parametros/Comprobar Parametros/a_Nuevo'), 0)

    WebUI.click(findTestObject('Modulo Parametros/Comprobar Parametros/a_Variable Organizacin'))

    WebUI.waitForElementVisible(findTestObject('Modulo Parametros/Comprobar Parametros/a_Nuevo'), 0)

    WebUI.click(findTestObject('Modulo Parametros/Comprobar Parametros/a_Variable Zona'))

    WebUI.waitForElementVisible(findTestObject('Modulo Parametros/Comprobar Parametros/a_Nuevo'), 0)

    WebUI.click(findTestObject('Modulo Parametros/Comprobar Parametros/a_Distribucin Costo'))

    WebUI.waitForElementVisible(findTestObject('Modulo Parametros/Comprobar Parametros/a_Nuevo'), 0)

    WebUI.click(findTestObject('Modulo Parametros/Comprobar Parametros/a_Variable Unidad'))

    WebUI.waitForElementVisible(findTestObject('Modulo Parametros/Comprobar Parametros/a_Nuevo'), 0)
}

def parReporte() {
    WebUI.click(findTestObject('Modulo Parametros/Comprobar Parametros/a_EmpleadosConceptos-Malla'))

    WebUI.waitForElementVisible(findTestObject('Modulo Parametros/Comprobar Parametros/a_Nuevo'), 0)

    WebUI.click(findTestObject('Modulo Parametros/Comprobar Parametros/a_Empleados y Conceptos'))

    WebUI.waitForElementVisible(findTestObject('Modulo Parametros/Comprobar Parametros/a_Nuevo'), 0)

    WebUI.click(findTestObject('Modulo Parametros/Comprobar Parametros/a_Concepto por Empleado'))

    WebUI.waitForElementVisible(findTestObject('Modulo Parametros/Comprobar Parametros/a_Nuevo'), 0)

    WebUI.click(findTestObject('Modulo Parametros/Comprobar Parametros/a_Resumen por Conceptos'))

    WebUI.waitForElementVisible(findTestObject('Modulo Parametros/Comprobar Parametros/a_Nuevo'), 0)

    WebUI.click(findTestObject('Modulo Parametros/Comprobar Parametros/a_Resumen Concepto-Malla'))

    WebUI.waitForElementVisible(findTestObject('Modulo Parametros/Comprobar Parametros/a_Nuevo'), 0)

    WebUI.click(findTestObject('Modulo Parametros/Comprobar Parametros/a_Fijos'))

    WebUI.waitForElementVisible(findTestObject('Modulo Parametros/Comprobar Parametros/a_Nuevo'), 0)
}

def parHorarios() {
    WebUI.click(findTestObject('Modulo Parametros/Comprobar Parametros/a_Tipo Franja'))

    WebUI.waitForElementVisible(findTestObject('Modulo Parametros/Comprobar Parametros/a_Nuevo'), 0)

    WebUI.click(findTestObject('Modulo Parametros/Comprobar Parametros/a_Tipo Receso'))

    WebUI.waitForElementVisible(findTestObject('Modulo Parametros/Comprobar Parametros/a_Nuevo'), 0)

    WebUI.click(findTestObject('Modulo Parametros/Comprobar Parametros/a_Tipo Horario'))

    WebUI.waitForElementVisible(findTestObject('Modulo Parametros/Comprobar Parametros/a_Nuevo'), 0)

    WebUI.click(findTestObject('Modulo Parametros/Comprobar Parametros/a_Sitios'))

    WebUI.waitForElementVisible(findTestObject('Modulo Parametros/Comprobar Parametros/a_Nuevo'), 0)

    WebUI.click(findTestObject('Modulo Parametros/Comprobar Parametros/a_Sitios Externos'))

    WebUI.waitForElementVisible(findTestObject('Modulo Parametros/Comprobar Parametros/a_Nuevo'), 0)

    WebUI.click(findTestObject('Modulo Parametros/Comprobar Parametros/a_Grupo'))

    WebUI.waitForElementVisible(findTestObject('Modulo Parametros/Comprobar Parametros/a_Nuevo'), 0)

    WebUI.click(findTestObject('Modulo Parametros/Comprobar Parametros/a_Ausencia'))

    WebUI.waitForElementVisible(findTestObject('Modulo Parametros/Comprobar Parametros/a_Nuevo'), 0)

    WebUI.click(findTestObject('Modulo Parametros/Comprobar Parametros/a_Conceptos'))

    WebUI.waitForElementVisible(findTestObject('Modulo Parametros/Comprobar Parametros/a_Nuevo'), 0)

    WebUI.click(findTestObject('Modulo Parametros/Comprobar Parametros/a_Tipo Liquidacin'))

    WebUI.waitForElementVisible(findTestObject('Modulo Parametros/Comprobar Parametros/a_Nuevo'), 0)

    WebUI.click(findTestObject('Modulo Parametros/Comprobar Parametros/a_Proceso Liquidacin'))

    WebUI.waitForElementVisible(findTestObject('Modulo Parametros/Comprobar Parametros/a_Nuevo'), 0)

    WebUI.click(findTestObject('Modulo Parametros/Comprobar Parametros/a_Tipo Labor'))

    WebUI.waitForElementVisible(findTestObject('Modulo Parametros/Comprobar Parametros/a_Nuevo'), 0)
}

def parGeneralesGna() {
    WebUI.click(findTestObject('Modulo Parametros/Comprobar Parametros/a_Consecutivo'))

    WebUI.waitForElementVisible(findTestObject('Modulo Parametros/Comprobar Parametros/a_Nuevo'), 0)

    WebUI.click(findTestObject('Modulo Parametros/Comprobar Parametros/a_Mensaje'))

    WebUI.waitForElementVisible(findTestObject('Modulo Parametros/Comprobar Parametros/a_Nuevo'), 0)

    WebUI.click(findTestObject('Modulo Parametros/Comprobar Parametros/a_Lista Actividades'))

    WebUI.waitForElementVisible(findTestObject('Modulo Parametros/Comprobar Parametros/a_Nuevo'), 0)
}

def parESeleccion() {
    WebUI.click(findTestObject('Modulo Parametros/Comprobar Parametros/a_Estado Candidato'))

    WebUI.waitForElementVisible(findTestObject('Modulo Parametros/Comprobar Parametros/a_Guardar'), 0)

    WebUI.click(findTestObject('Modulo Parametros/Comprobar Parametros/a_Estado Proceso Seleccin'))
