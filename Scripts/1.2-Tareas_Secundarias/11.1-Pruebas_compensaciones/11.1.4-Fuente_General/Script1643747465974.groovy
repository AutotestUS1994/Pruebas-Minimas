...
WebUI.setText(findTestObject('Modulo Tarea Sara General/Importar Fuente General/input_Procesos Generados_formImportarListadoFuentej_idt67'), 
    'Creación prestamos')

WebUI.sendKeys(findTestObject('Modulo Tarea Sara General/Importar Fuente General/input_Procesos Generados_formImportarListadoFuentej_idt67'), 
    Keys.chord(Keys.ENTER))

WebUI.click(findTestObject('Modulo Tarea Sara General/Importar Fuente General/td_Creacin Prestamos'))

String ruta = GlobalVariable.G_rutaarchivos + 'carguePrestamo.txt'

WebUI.uploadFile(findTestObject('Modulo Tarea Sara General/Importar Fuente General/input_Cargar_formImportarFuentetabarchivo_input'), 
    ruta)
