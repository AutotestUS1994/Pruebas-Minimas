...
String Puesto = WebUI.getText(findTestObject('Modulo compensaciones/Terminación_de_Contrato_Definitivo/td_10247'))
...
if (WebUI.waitForElementVisible(findTestObject('Modulo compensaciones/Terminación_de_Contrato_Definitivo/p_Puesto de trabajo ocupado (A1           12)'), 
    1)) {
    WebUI.setText(findTestObject('Modulo compensaciones/Terminación_de_Contrato_Definitivo/input_Empresa 1_form_templatej_idt24_input'), 
        'Planta personal (tal)')
    ...
    WebUI.click(findTestObject('Modulo compensaciones/Terminación_de_Contrato_Definitivo/a_Parmetros_organigramabuscar'))

    WebUI.selectOptionByIndex(findTestObject('Modulo compensaciones/Terminación_de_Contrato_Definitivo/select_--Seleccione--EmpleadoPuesto'), 
        2)

    WebUI.setText(findTestObject('Modulo compensaciones/Terminación_de_Contrato_Definitivo/input_Puesto_popupBusquedaPlantapuesto'), 
        Puesto)

    WebUI.sendKeys(findTestObject('Modulo compensaciones/Terminación_de_Contrato_Definitivo/input_Puesto_popupBusquedaPlantapuesto'), 
        Keys.chord(Keys.ENTER))

    WebUI.click(findTestObject('Modulo compensaciones/Terminación_de_Contrato_Definitivo/span_23       - Aprendiz Sena Lectiva'))

    WebUI.setText(findTestObject('Modulo compensaciones/Terminación_de_Contrato_Definitivo/input_A1            - ADMINISTRACION_organigramalistaPuestosActivosj_idt150'), 
        Puesto)

    WebUI.sendKeys(findTestObject('Modulo compensaciones/Terminación_de_Contrato_Definitivo/input_A1            - ADMINISTRACION_organigramalistaPuestosActivosj_idt150'), 
        Keys.chord(Keys.ENTER))

    WebUI.click(findTestObject('Modulo compensaciones/Terminación_de_Contrato_Definitivo/a_Aprendiz Sena Lectiva_organigramaj_idt113'))

    WebUI.selectOptionByIndex(findTestObject('Modulo compensaciones/Terminación_de_Contrato_Definitivo/select_-- Seleccione --BloqueadoEliminadoOcupado y disponibleOcupado'), 
        6)

    WebUI.selectOptionByIndex(findTestObject('Modulo compensaciones/Terminación_de_Contrato_Definitivo/select_-- Seleccione --No ReservadoReservado'), 
        1)

    WebUI.click(findTestObject('Modulo compensaciones/Terminación_de_Contrato_Definitivo/span_Actualizar'))
    ...
    String Puesto0 = WebUI.getText(findTestObject('Modulo compensaciones/Terminación_de_Contrato_Definitivo/td_10247'))
    ...
    if (WebUI.waitForElementVisible(findTestObject('Modulo compensaciones/Terminación_de_Contrato_Definitivo/a_Regresar'), 
        1)) {
        WebUI.closeBrowser()
    }
} else {
