...
String Puesto = WebUI.getAttribute(findTestObject('Modulo Pruebas Planta de Personal/Crear_un_puesto_de_trabajo/a_puesto'), 
    'Value')
...
WebUI.setText(findTestObject('Modulo Pruebas Planta de Personal/Buscar_puesto_de_trabajo/input_Buscar'), Puesto)

WebUI.sendKeys(findTestObject('Modulo Pruebas Planta de Personal/Buscar_puesto_de_trabajo/input_Buscar'), Keys.chord(Keys.ENTER))

WebUI.click(findTestObject('Modulo Pruebas Planta de Personal/Buscar_puesto_de_trabajo/span_20139    - Abogado'))

WebUI.click(findTestObject('Modulo Pruebas Planta de Personal/Buscar_puesto_de_trabajo/a_Abogado_organigramaj_idt113'))

WebUI.scrollToElement(findTestObject('Modulo Pruebas Planta de Personal/Crear_un_puesto_de_trabajo/a_puesto'), 0)
